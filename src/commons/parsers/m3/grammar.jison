...
AnnotationStatements
    : AnnotationStatement
    | AnnotationStatements AnnotationStatement
        {
            //$$ = _.concat($1, $2);
            $$ = _.merge($1, $2);
        } 
...
AnnotationStatement
    : ANNOTATION LITERAL OPENPARENTECIS AnnotationProperties CLOSEPARENTECIS
        {
            var annotation = $2;
            var annotations = {};
            _.set(annotations,annotation,{
                    "name": $2,
                    "attributes": $4,
            });
            $$ = annotations;
...
TypeStatement
    ...
    | AnnotationStatements CUSTOMTYPE LITERAL OPENBRACE EntityAttributes CLOSEBRACE
        {
            var type = $3;
            var types = {};
            _.set(types,type,{
...
EntityStatement
    ...
    | AnnotationStatements ENTITY LITERAL OPENBRACE EntityAttributes CLOSEBRACE
        {
            var entity = $3;
            var entities = {};
            _.set(entities,entity,{
    ...
    | AnnotationStatements ENTITY LITERAL IS LITERAL OPENBRACE EntityAttributes CLOSEBRACE
        {
            var entity = $3;
            var entities = {};
            _.set(entities,entity,{
...
AnnotationProperties
    : AnnotationProperty
    | AnnotationProperties COMMA AnnotationProperty
        {
            //$$ = _.concat($1, $3);
            $$ = _.merge($1, $3);
        }
...
ServiceStatement
    ...
    | AnnotationStatements SERVICE LITERAL OPENBRACE ServiceActions CLOSEBRACE
        {
            $$ = {"services" :{
                "service": {
                    "name": $3,
...
%%
_ = require("lodash")
debug = require('debug')("w:cli:meta:jison");
function hello(obj) {
    debug("HELLO");
}