...
@CommandDefinition({ 
    ...
    parent: 'meta',  
    examples: [
        [`meta model helloworld.m3 --format json --outout helloworld.json`, `Export model as json file`],
        [`meta model helloworld.m3 --format yaml --outout helloworld.yaml`, `Export model as yaml file`],
    ]
})
